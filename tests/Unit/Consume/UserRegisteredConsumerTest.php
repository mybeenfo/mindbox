...
use Market\MessageBus\Messages\UserRegistratedMessage;
use Market\MessageBus\MessagesFactory;
use PhpAmqpLib\Message\AMQPMessage;
use PHPUnit\Framework\TestCase;
use Psr\Log\NullLogger;

class UserRegisteredConsumerTest extends TestCase
{
    public function testConsume(): void
    {
        $message = $this->createMock(UserRegistratedMessage::class);
        $message->userId = 1;
        $body = 'body';
