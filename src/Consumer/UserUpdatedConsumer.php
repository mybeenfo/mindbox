...
use App\MindboxMessages\Json\User\UserUpdatedMindboxMessage;
...
/**
 * Class UserUpdatedConsumer.
 *
 * @project mindbox
 **/
class UserUpdatedConsumer implements ConsumerInterface, BatchConsumerInterface
{
    ...
    public function execute(AMQPMessage $msg)
    {
        try {
            ...
            try {
                ...
                $result = $this->mindboxApiClient->post(new UserUpdatedMindboxMessage($user));

                $this->logger->info('User updated in mindbox service', [
                    'class'       => __CLASS__,
